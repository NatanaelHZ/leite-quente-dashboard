...
const RevenueExpenditureEdit = ({ id, ...rest }) => {
  ...
  const submitForm = () => {
    ...
    revenueExpenditureService.update(id, formValues).then(
      () => {
  ...
  useEffect(() => {
    console.log(`IDENTIFICADOR revenueExpenditure: ${id}`);
    if (id) {
      revenueExpenditureService.get(id).then(
        (result) => {
...
RevenueExpenditureEdit.propTypes = {
  id: PropTypes.array.isRequired
};

export default RevenueExpenditureEdit;
